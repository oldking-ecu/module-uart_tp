...
- 该协议在串口自定义协议中应用最广泛
- CRC计算包括Len16部分
- eg:AA 55 04 00 12 34 56 78 7A AB 55 
---
...
- 有头标记(0x02)和尾标记(0x03),自定义头尾的需要确保数据中不会出现头尾！！
- 适用于纯ASCII字符传输场景
- eg:02 68 65 6C 6C 6F 20 77 6F 72 6C 64 21 35 43 38 41 03 (0x02"hello world!5C8A"0x03)
---
